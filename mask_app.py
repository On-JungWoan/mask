...
from utils import init_sam_model, init_tracker, track_masks
...
class PromptGUI(object):
    ...
    def set_input_image(self, i: int = 0) -> np.ndarray:
...
def make_demo(
    ...
    with gr.Blocks() as demo:
        ...
        def update_mask_dir(root_dir, mask_name, seq_name):
            return f"../outputs/{seq_name}/{mask_name}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir", default='/home/user/datasets/arctic_hold', type=str)
